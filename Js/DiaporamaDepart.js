...
function jsSlide(aData){
	...
	me.intervalTiming = 10000;	// pause en milliseconde utilisé par SetInterval
...
//			eChild[i].style.fixed = 'left';
//eChild[i].style.position = '50 0 0 50';
//eChild[i].style.dimensions = 'min-width: 100%';
	...
	me.SlideAnimPrepare = function(){
		...
		else if(me.sens == -1 && me.slideNb <= 0) me.sens = 0;
